export const state = () => ({
  ...
  locations: [
    ...
    { id: 7, title: 'Торговый центер', img: 'url', roles: ['Покупатель', 'Бизнесмен', 'Охранник', 'Безработный', 'Школьник', 'Студент', 'Многодетная мать', 'Кассир', 'Мороженщик', 'Консультант'], requires: true },
    ...
    { id: 14, title: 'Кладбище', img: 'url', roles: ['Охранник', 'Погребальщик', 'Плакальщик', 'Поминальщик', 'Гость', 'Гробовщик', 'Полицейский', 'Ритуальный агент', 'Бальзамировщик', 'Крематор'], requires: true },
